...
class Image_Classification_UI():
  ...
  def __init__(self):
    ...
    self.ui_c1=widgets.HBox([widgets.VBox([self.b1, self.b3]), widgets.VBox([self.b5, self.b6])],layout=widgets.Layout(margin='40px 0 0 40px'))
    self.ui_c2=widgets.HBox([self.b4],layout=widgets.Layout(margin='40px 0 0 40px'))
    self.ui_c3=widgets.HBox([widgets.VBox([self.b8, self.b7]), widgets.VBox([self.b9, self.b2])],layout=widgets.Layout(margin='40px 0 0 40px'))
